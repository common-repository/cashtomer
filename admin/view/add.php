...
if( isset($_POST['points_submit']) ){
	$data = array('earntype' => sanitize_text_field($_GET['id']), 'points' => sanitize_text_field($_POST['points']), 'status' => sanitize_text_field($_POST['status']) );
	$format = array('%s','%d');
...
if( isset($_POST['edit_points_submit']) && isset($_GET['editid']) ){
	$wpdb->update( 
		$table, 
		array( 
			'earntype' => sanitize_text_field($_GET['id']),
         ...
         <div class="Wlp-Page-Header Wlp-Page-Header__Header--hasBreadcrumbs Wlp-Page-Header__Header--hasSecondaryActions Wlp-Page-Header__Header--hasRollup">
            ...
            <div id="ember2047" class="ember-view Wlp-Page-Header__MainContent">
                           ...
                           <div class="Wlp-Stack Wlp-Stack--spacingTight Wlp-Stack--alignmentBaseline">
                              <div class="Wlp-Stack__Item" >
                                 <h1 id="ember2051" class="ember-view Wlp-DisplayText Wlp-DisplayText--sizeLarge">
									<?php 
									if($_GET['id'] == 'placeorder'){ echo esc_html( __( 'Place an order', 'cashtomer' ) ); }
									if($_GET['id'] == 'signup'){ echo esc_html( __( 'Signup', 'cashtomer' ) ); }
									?>                                
                                 </h1>
                              </div>
                           </div>
               ...
               <div class="Wlp-Page-Header__PrimaryAction">
                  ...
                  <button class="Wlp-Button Wlp-Button--primary" type="submit" name="edit_points_submit">
                     <span class="Wlp-Button__Content">
				  ...
				  <?php } else { ?>
				  <button class="Wlp-Button Wlp-Button--primary" type="submit" name="points_submit">
                     <span class="Wlp-Button__Content">
                        <span class="Wlp-Button__Text">
                        Save
                        </span>
                              ...
                              <div data-test-labelled="text-field">
                                 <div class="Wlp-Labelled__LabelWrapper">
                                    <div data-test-label="" class="Wlp-Label ">
                                       ...
                                       <?php 
										if($_GET['id'] == 'placeorder'){ echo esc_html( __( 'Points earned for every '.get_woocommerce_currency_symbol().'1 spent', 'cashtomer' ) ); }
										if($_GET['id'] == 'signup'){ echo esc_html( __( 'Points awarded', 'cashtomer' ) ); }
										?> 
                                       </label>
                                    </div>                                        
                                 </div>
                        ...
                        <div data-test-stack="" class="Wlp-Stack Wlp-Stack--spacingLoose Wlp-Stack--vertical">
                           <div class="Wlp-Stack__Item" data-test-stack-item="true">
                              <div data-test-stack="" class="Wlp-Stack Wlp-Stack--alignmentCenter Wlp-Stack--distributionEqualSpacing">
                                 <div class="Wlp-Stack__Item" data-test-stack-item="true">
                                    <h2 id="ember2108" class="ember-view Wlp-Heading " data-test-Wlp-heading="">
                                       Summary
                                    </h2>
                                 </div>
                           ...
                           <div class="Wlp-Stack__Item" data-test-stack-item="true">                              
							...
							Customers earn <?php if($points){echo $points[0]; } ?> points for every <?php echo get_woocommerce_currency_symbol(); ?>1 spent
							</div>
							</li>
							</ul>
							<?php
                        ...
                        <div class="Wlp-Stack__Item">
                           <div class="Wlp-ButtonGroup">
                              <div class="Wlp-ButtonGroup__Item">
							     <a href="?page=add-earn-point&id=<?php echo sanitize_text_field($_GET['id']); ?>&delid=<?php echo sanitize_text_field($_GET['editid']); ?>">
